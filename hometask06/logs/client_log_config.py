...
LOG_PATH = str(os.path.join(LOG_PATH, 'client_log.log')).replace('\\','/')
...
LOG_FORMATTER = logging.Formatter('%(asctime)-22s : %(levelname)-8s : %(filename)-13s : %(message)s')
